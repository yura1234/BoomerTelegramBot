...
from bot.handlers import admin, menu, support_chat
...
# from bot.keyboards.buttons import diag_equip_btns
...
async def main() -> None:
    ...
    # dp.startup.register(register_all_handlers)
    dp.include_routers(admin.router, menu.router, support_chat.router)
